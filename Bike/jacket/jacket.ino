...
void twinkle(){
  int augmentedColor = 160 ;
  for (int i = 0; i < NUM_LEDS; i++) {
    
   CHSV color =  CHSV(augmentedColor, 255, 255);
    
    leds[i] =  color;
  }
  addTwinkles(leds, NUM_LEDS, augmentedColor);
}
...
void addTwinkles(CRGB leds[], int count, int augmentedColor) {
...
void confetti() 
{
  ...
  leds[pos] += CHSV( gHue + random8(64), 220, 255);
}
